...
function LAB5_1() {
  return (
    <div>
      ...
      <div>
        <button>+</button>
        <span className="external">0</span>
        <button>-</button>
        <button className="external">Reset</button>
      </div>
      <hr />
    </div>
  );
  ...
  return (
    <>
      ...
      <div>
        ...
        <div>
          <span className="taskName crossOut">Task 1</span>
...
function Control() {
  return (
    <div className="block control">
      <div>
        <button className="bt btRed">Roll</button>
        <button className="bt btGreen">Keep</button>
      </div>
      <div className="rollResult">1</div>
...
function LAB5_4() {
  return (
    <>
      <div className="bar barTwoSide">
        <span>To Do List App</span>
        <div>
          <input id="search" placeholder="Search"></input>
          <button className="btBar">Search</button>
          <button className="btBar">Add</button>
        </div>
      </div>
      <div class="container">
        <ToDo />
